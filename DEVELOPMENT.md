...
```bash
git remote add encore encore://archeey-master-course-landing-page-reci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/archeey-master-course-landing-page-reci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/archeey-master-course-landing-page-reci/settings/integrations/github)
